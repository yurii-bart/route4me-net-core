...
namespace Route4MeSDK.QueryTypes.V5
{
    ...
    public sealed class OptimizationParameters : GenericParameters
    {
        ...
        ///     (After a PUT there is no guarantee that the route_destination_id values are preserved! It may create copies
        ///     resulting in new destination IDs, especially when dealing with multiple depots.)
        /// </summary>
